...
public class ExerciciosEmSala {
    ...
    public void primeiraAula() {
        //1. Declarar um array sem utilizar a inicialização direta e imprimir um elemento qualquer
        ...
        //4. Dado o seguinte array de inteiros int[] inteiros = {10, 20, 30, 40, 50};, imprima os valores separados por quebra de linha
        int[] inteiros = {10, 20, 30, 40, 50};
        for (int i = 0; i < inteiros.length; i++) {
            System.out.println(inteiros[i]);
        }
        //5. Dado o seguinte array de números double[] notas = {7.5, 8.0, 6.5, 9.0};, calcule e imprima a média dos valores.
        ...
        //6. Dado o seguinte array de inteiros int[] numeros = {5, 12, 8, 20, 3};, verifique se o número 8 existe no array e imprima a sua posição.
        ...
        //7. Dado o seguinte array de inteiros int[] valores = {1, 2, 3, 2, 4, 2};, substitua todos os valores 2 por 9 e imprima o array atualizado.
        ...
        //8. Dado o seguinte array de nomes String[] assentos = {"Ana", null, "Carlos","", "Mariana"};, imprima os índices dos assentos que estão vazios.
        ...
        //9. Dado o seguinte array de idades int[] idades = {18, 20, 25, 30, 22};, calcule e imprima a média das idades.
        ...
        //10. Dado o seguinte array de inteiros int[] numeros = {15, 3, 27, 8, 19};, determine e imprima o maior e o menor valor do array.
        ...
        //11. Dado o seguinte array bidimensional representando um hotel String[][] hospedes = new String[][] {{"Rex", "Toto", "Bruce"}, {"Amora", "Dulce", "Brutus"}};, troque o hóspede "Dulce" pelo hóspede "Barto" e imprima o array atualizado.

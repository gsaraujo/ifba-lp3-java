...
public class Client {
    public static void main(String[] args) {
        try {
            ...
            Socket socket = new Socket(server, port);//criação do iiiunidade.socket no cliente -> quando a conexão é aceita pelo servidor (pelo iiiunidade.socket do servidor)
            ...
            OutputStream outputStream = socket.getOutputStream();//o iiiunidade.socket.getOutputStream() faz algumas verificações e retornar um new OutputStream(); vinculado ao servidor. Ou seja, é um "canal" para enviar informações do cliente para o servidor.

...
public class ResolucaoFinalBoss {
    ...
    public void q1(int[] array, int target) {
        //Aqui a gente usa um parâmetro na função para poder receber o valor do iunidade.array que será passado na chamada da função
    ...
    public void q3() {
        ...
        for (int i = nums.length - 1; i >= 0; i--) {
            ...
            if (pilha.isEmpty()) {
                ...
                //usando o iunidade.array da questão como exemplo, o 8 não possui nenhum número a direita que é maior do que ele (já que ele é o último item do iunidade.array)
